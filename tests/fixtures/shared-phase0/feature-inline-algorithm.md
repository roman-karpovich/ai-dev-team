# feature/SKILL.md — inline-algorithm fixture (rollback case)

This negative fixture simulates a full rollback: shared-doc reference absent,
inline 9-step algorithm reappeared. The `check_skill_phase0_no_inline_algorithm`
helper must reject.
