...
- Status: IN PROGRESS
<!-- emitted only when project_type unset / non-allowlist — see §R-rule cluster gate above; the bullet is conditional, omitted when project_type resolves to an allowlist value -->
